...
#pragma region ----- くらい判定登録 -----
	//	{名前、半径、	オフセット位置、ダメージ倍率、	更新名(位置更新の基とするノードの名前)、	デフォルトカラー、	ヒットカラー}
	//	{name, radius,	offsetPos,		damage,			updateName,									defaultColor,		hitColor}

	RegisterDamageDetectionData({ "head",			0.6f,{},1.0f, "head" });		//	頭
	RegisterDamageDetectionData({ "spine_02",		0.6f,{},1.0f, "spine_02" });	//	胸部
	RegisterDamageDetectionData({ "Shoulder_L",		0.6f,{},1.0f, "Shoulder_L" });	//	左肩
	RegisterDamageDetectionData({ "Shoulder_R",		0.6f,{},1.0f, "Shoulder_R" });	//	右肩
	RegisterDamageDetectionData({ "lowerarm_l",		0.6f,{},1.0f, "lowerarm_l" });	//	左肘
	RegisterDamageDetectionData({ "lowerarm_r",		0.6f,{},1.0f, "lowerarm_r" });	//	右肘
	RegisterDamageDetectionData({ "Hand_L",			0.7f,{},1.0f, "Hand_L" });		//	左手首
	RegisterDamageDetectionData({ "Hand_R",			0.7f,{},1.0f, "Hand_R" });		//	右手首
	RegisterDamageDetectionData({ "spine_01",		1.5f,{},1.0f, "spine_01" });	//	腰
	RegisterDamageDetectionData({ "calf_l",			1.1f,{},1.0f, "calf_l" });		//	左膝
	RegisterDamageDetectionData({ "calf_r",			1.1f,{},1.0f, "calf_r" });		//	右膝
	RegisterDamageDetectionData({ "Foot_L",			1.1f,{},1.0f, "Foot_L" });		//	左足首
	RegisterDamageDetectionData({ "Foot_R",			1.1f,{},1.0f, "Foot_R" });		//	右足首
	RegisterDamageDetectionData({ "Steps",			0.7f,{-190.0f,0.0f,0.0f},1.0f, "spine_01" });	//	足元

	//	左の翼
	RegisterDamageDetectionData({ "Wing_L03",		0.72f,{},1.0f, "Wing_L03" });	//	一番付け根に近い
	RegisterDamageDetectionData({ "Wing_L04",		0.72f,{},1.0f, "Wing_L04" });
	RegisterDamageDetectionData({ "Wing_L05",		0.72f,{},1.0f, "Wing_L05" });
	RegisterDamageDetectionData({ "Wing_L05_1",		0.72f,{63.65f,0.0f,0.0f},1.0f, "Wing_L05" });
	RegisterDamageDetectionData({ "Wing_L05_2",		0.72f,{130.0f,0.0f,0.0f},1.0f, "Wing_L05" });
	RegisterDamageDetectionData({ "Wing_L06",		0.72f,{},1.0f, "Wing_L06" });
	RegisterDamageDetectionData({ "Wing_L06_1",		0.72f,{80.0f,-25.8f,0.0f},1.0f, "Wing_L06" });
	RegisterDamageDetectionData({ "Wing_L06_2",		0.72f,{153.43f,-52.54f,0.0f},1.0f, "Wing_L06" });
	RegisterDamageDetectionData({ "Wing_L06_3",		0.72f,{215.11f,-32.81f,0.0f},1.0f, "Wing_L06" });
	RegisterDamageDetectionData({ "Wing_L06_4",		0.72f,{268.52f,-32.81f,0.0f},1.0f, "Wing_L06" });
	RegisterDamageDetectionData({ "Wing_L08",		0.72f,{},1.0f, "Wing_L08" });
	RegisterDamageDetectionData({ "Wing_L08_1",		0.72f,{264.0f,86.0f,-57.998f},1.0f, "Wing_L08" });
	RegisterDamageDetectionData({ "Wing_L08_2",		0.8f,{318.06f,-57.98f,0.0f},1.0f, "Wing_L08" });
	RegisterDamageDetectionData({ "Wing_L09",		0.72f,{},1.0f, "Wing_L09" });
	RegisterDamageDetectionData({ "Wing_L09_1",		0.72f,{250.0f,0.0f,0.0f},1.0f, "Wing_L09" });
	RegisterDamageDetectionData({ "Wing_L10",		0.72f,{},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_1",		0.72f,{205.2f,-33.42f,-9.8f},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_2",		0.72f,{150.0f,-34.34f,-9.0f},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_3",		0.72f,{300.0f,-34.34f,-9.0f},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_4",		0.72f,{344.59f,-34.34f,-9.0f},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_5",		0.72f,{395.25f,-34.34f,-9.0f},1.0f, "Wing_L10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_L10_6",		0.72f,{424.93f,-48.13f,6.36f},1.0f, "Wing_L10" });	//	一番先の方

	//	右の翼
	RegisterDamageDetectionData({ "Wing_R03",		0.72f,{},1.0f, "Wing_R03" });	//	一番付け根に近い
	RegisterDamageDetectionData({ "Wing_R04",		0.72f,{},1.0f, "Wing_R04" });
	RegisterDamageDetectionData({ "Wing_R05",		0.72f,{},1.0f, "Wing_R05" });
	RegisterDamageDetectionData({ "Wing_R05_1",		0.72f,{63.65f,0.0f,0.0f},1.0f, "Wing_R05" });
	RegisterDamageDetectionData({ "Wing_R05_2",		0.72f,{130.0f,0.0f,0.0f},1.0f, "Wing_R05" });
	RegisterDamageDetectionData({ "Wing_R06",		0.72f,{},1.0f, "Wing_R06" });
	RegisterDamageDetectionData({ "Wing_R06_1",		0.72f,{80.0f,-25.8f,0.0f},1.0f, "Wing_R06" });
	RegisterDamageDetectionData({ "Wing_R06_2",		0.72f,{153.43f,-52.54f,0.0f},1.0f, "Wing_R06" });
	RegisterDamageDetectionData({ "Wing_R06_3",		0.72f,{215.11f,-32.81f,0.0f},1.0f, "Wing_R06" });
	RegisterDamageDetectionData({ "Wing_R06_4",		0.72f,{268.52f,-32.81f,0.0f},1.0f, "Wing_R06" });
	RegisterDamageDetectionData({ "Wing_R08",		0.72f,{},1.0f, "Wing_R08" });
	RegisterDamageDetectionData({ "Wing_R08_1",		0.72f,{264.0f,86.0f,-57.998f},1.0f, "Wing_R08" });
	RegisterDamageDetectionData({ "Wing_R08_2",		0.8f,{318.06f,-57.98f,0.0f},1.0f, "Wing_R08" });
	RegisterDamageDetectionData({ "Wing_R09",		0.72f,{},1.0f, "Wing_R09" });
	RegisterDamageDetectionData({ "Wing_R09_1",		0.72f,{250.0f,0.0f,0.0f},1.0f, "Wing_R09" });
	RegisterDamageDetectionData({ "Wing_R10",		0.72f,{},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_1",		0.72f,{205.2f,-33.42f,-9.8f},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_2",		0.72f,{150.0f,-34.34f,-9.0f},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_3",		0.72f,{300.0f,-34.34f,-9.0f},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_4",		0.72f,{344.59f,-34.34f,-9.0f},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_5",		0.72f,{395.25f,-34.34f,-9.0f},1.0f, "Wing_R10" });	//	一番先の方
	RegisterDamageDetectionData({ "Wing_R10_6",		0.72f,{424.93f,-48.13f,6.36f},1.0f, "Wing_R10" });	//	一番先の方
...
#pragma region ----- 攻撃判定登録 -----
	...
	RegisterAttackDetectionData({ "Hand_L",			1.1f,{}, "Hand_L" });		//	左手首
	RegisterAttackDetectionData({ "Hand_R",			1.2f,{}, "Hand_R" });		//	右手首
	RegisterAttackDetectionData({ "Hand_R_1",		1.2f,{34.2f,0.0f,0.0f}, "Hand_R" });		//	右手首
	RegisterAttackDetectionData({ "spine_01",		0.4f,{}, "spine_01" });		//	腰
	RegisterAttackDetectionData({ "calf_l",			1.1f,{}, "calf_l" });		//	左膝
	RegisterAttackDetectionData({ "calf_r",			1.1f,{}, "calf_r" });		//	右膝
	RegisterAttackDetectionData({ "Foot_L",			1.1f,{}, "Foot_L" });		//	左足首
	...
	RegisterAttackDetectionData({ "Wing_L05_2",		0.72f,{130.0f,0.0f,0.0f}, "Wing_L05" });
	RegisterAttackDetectionData({ "Wing_L06",		0.72f,{}, "Wing_L06" });
	RegisterAttackDetectionData({ "Wing_L06_1",		0.72f,{80.0f,-25.8f,0.0f}, "Wing_L06" });
	RegisterAttackDetectionData({ "Wing_L06_2",		0.72f,{153.43f,-52.54f,0.0f}, "Wing_L06" });
	RegisterAttackDetectionData({ "Wing_L06_3",		0.72f,{215.11f,-32.81f,0.0f}, "Wing_L06" });
	RegisterAttackDetectionData({ "Wing_L06_4",		0.72f,{268.52f,-32.81f,0.0f}, "Wing_L06" });
	RegisterAttackDetectionData({ "Wing_L08",		0.72f,{}, "Wing_L08" });
	RegisterAttackDetectionData({ "Wing_L08_1",		0.72f,{264.0f,86.0f,-57.998f}, "Wing_L08" });
	...
	RegisterAttackDetectionData({ "Wing_R05_2",		0.72f,{130.0f,0.0f,0.0f}, "Wing_R05" });
	RegisterAttackDetectionData({ "Wing_R06",		0.72f,{}, "Wing_R06" });
	RegisterAttackDetectionData({ "Wing_R06_1",		0.72f,{80.0f,-25.8f,0.0f}, "Wing_R06" });
	RegisterAttackDetectionData({ "Wing_R06_2",		0.72f,{153.43f,-52.54f,0.0f}, "Wing_R06" });
	RegisterAttackDetectionData({ "Wing_R06_3",		0.72f,{215.11f,-32.81f,0.0f}, "Wing_R06" });
	RegisterAttackDetectionData({ "Wing_R06_4",		0.72f,{268.52f,-32.81f,0.0f}, "Wing_R06" });
	RegisterAttackDetectionData({ "Wing_R08",		0.72f,{}, "Wing_R08" });
	RegisterAttackDetectionData({ "Wing_R08_1",		0.72f,{264.0f,86.0f,-57.998f}, "Wing_R08" });
